    ...
    public class MockDataStore : IDataStore<Presenter>
    {
        ...
        private void SeedData()
        {
            ...
            var newitems = new List<Presenter>()
            {
                ...
                new Presenter { Id = Guid.NewGuid().ToString(), Name = "Lachlan Gordon", Description="This is an item description.", ImageUrl="https://pbs.twimg.com/profile_images/1052124537821614080/thXH8950_400x400.jpg" },

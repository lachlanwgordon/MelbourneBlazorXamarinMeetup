...
namespace MelbourneModernApp.Core.Services
{
    public class PresenterDataStore : IDataStore<Presenter>
    {
        ...
        public static Presenter Lachlan = new Presenter { Id = "9cb75bed-d7db-4a58-a3a0-e6523668061d", Name = "Lachlan Gordon", Description = "This is an item description.", ImageUrl = "https://pbs.twimg.com/profile_images/1052124537821614080/thXH8950_400x400.jpg" };
